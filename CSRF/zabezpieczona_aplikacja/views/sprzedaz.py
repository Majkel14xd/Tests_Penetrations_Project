...
def get_sprzedaz(per_page=8, page=1, start_date=None, end_date=None):
    ...
    if start_date and end_date:
        ...
        query = "SELECT * FROM sprzedaz WHERE sprzedaz.data_sprzedazy BETWEEN ? AND ? LIMIT ? OFFSET ?"
        cursor.execute(query, (sanitized_start_date, sanitized_end_date, per_page, offset))
